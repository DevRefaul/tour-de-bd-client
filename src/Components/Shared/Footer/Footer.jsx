...
const Footer = () => {
  return (
    <>
      <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900 mt-6 border ">
        <div class="md:flex md:justify-between w-[80%] mx-auto">
          <div class="mb-6 md:mb-0">
            <Link to="/" class="flex items-center">
              <img src={logo} class="mr-3 h-20 xl:h-28" alt="tour de bd logo" />
            </Link>
          </div>
        ...
        {/* bottom footer start */}
        <div class="sm:flex sm:items-center sm:justify-between w-[80%] mx-auto">
